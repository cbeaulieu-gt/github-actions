...
Note: The Business-tier "credits" pricing uses a different denomination than the Responses API dollar pricing. The Responses API `gpt-5-codex` prices above are in USD per 1M tokens, verified from the models documentation.
